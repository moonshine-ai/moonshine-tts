#ifndef MOONSHINE_G2P_LANG_SPECIFIC_SPANISH_UNICODE_TABLES_H
#define MOONSHINE_G2P_LANG_SPECIFIC_SPANISH_UNICODE_TABLES_H
...
#endif  // MOONSHINE_G2P_LANG_SPECIFIC_SPANISH_UNICODE_TABLES_H
