#ifndef MOONSHINE_G2P_LANG_SPECIFIC_CHINESE_NUMBERS_H
#define MOONSHINE_G2P_LANG_SPECIFIC_CHINESE_NUMBERS_H
...
#endif  // MOONSHINE_G2P_LANG_SPECIFIC_CHINESE_NUMBERS_H
